...
class TestMessagesServiceCRUD:
    ...
    def test_create_message(self, sqlite_store):
    ...
    def test_create_message_duplicate_raises_error(self, sqlite_store):
    ...
    def test_get_message(self, sqlite_store):
    ...
    def test_get_message_not_found(self, sqlite_store):
    ...
    def test_list_messages(self, sqlite_store):
    ...
    def test_list_messages_with_limit(self, sqlite_store):
    ...
    def test_list_messages_with_offset(self, sqlite_store):
    ...
    def test_list_messages_empty(self, sqlite_store):
    ...
    def test_update_message(self, sqlite_store):
    ...
    def test_update_message_partial(self, sqlite_store):
    ...
    def test_update_message_not_found(self, sqlite_store):
    ...
    def test_delete_message(self, sqlite_store):
    ...
    def test_delete_message_not_found(self, sqlite_store):
